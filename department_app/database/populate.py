...
def populate_database():
    ...
    department_2 = Item_department('Purchasing', 'Amazon')
    department_3 = Item_department('Human Resource Management', 'Huawei')

    employee_1 = Item_employee('John Doe', '1979-12-02', 2000, 1)
    employee_2 = Item_employee('Jane Wilson', '1983-05-14', 2100, 2)
    employee_3 = Item_employee('Will Hunting', '1988-03-07', 1800, 3)
